...
export class WindsurfPatchService {
    ...
    private static readonly ORIGINAL_HANDLE_AUTH_TOKEN_PATTERNS = [
        // 版本 1: 2024.12.24+ (E.registerUser)
        ...
        // 版本 2: 当前版本 (E.registerUser, name:i)
